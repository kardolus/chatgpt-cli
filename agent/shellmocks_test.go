...
// Source: github.com/kardolus/chatgpt-cli/agent (interfaces: Shell)
...
func (m *MockShell) Run(arg0 context.Context, arg1, arg2 string, arg3 ...string) (agent.Result, error) {
	m.ctrl.T.Helper()
