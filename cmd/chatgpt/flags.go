...
func setCustomHelp(rootCmd *cobra.Command) {
	...
	rootCmd.SetHelpFunc(func(cmd *cobra.Command, args []string) {
		...
		printFlagWithPadding("--mcp", "MCP endpoint URL (e.g. http://localhost:3333 or 'you' for You.com)")
...
func setupFlags(rootCmd *cobra.Command) {
	...
	rootCmd.PersistentFlags().StringVar(&mcpEndpoint, "mcp", "", "MCP endpoint URL (e.g. http://localhost:3333 or 'you' for You.com)")
